 ...
 * 
 * <p>
 * A RomanNumeral only represents natural numbers, that is integers greater than 0. The maximum integer value of a RomanNumeral is 4999. The
 * RomanNumeral can be displayed either in archaic style (4 = IIII) or modern style (4 = IV). The default display is modern.
 * </p>
 * 
 * @author Lara Burton
 * @version 2009-11-17
...
public class RomanNumeral extends Number {
    ...
    /***************************************************************************
     * <p>
     * Flags whether or not the RomanNumeral style is archaic (if not archaic, the style is modern.
     * </p>
     **************************************************************************/
    ...
    /***************************************************************************
     * <p>
     * Creates new RomanNumeral with style set to modern (4 = IV) and value of 1 (I).
     * </p>
     **************************************************************************/
    public RomanNumeral() {
    ...
    /***************************************************************************
     * <p>
     * Creates new RomanNumeral with style set to modern (4 = IV) with the value of the number equal to int.
     * </p>
     * 
     * @param value An int value to convert to a Roman numeral
     * @exception NumberFormatException if the parameter is out of range
     **************************************************************************/
    ...
    /***************************************************************************
     * <p>
     * Creates new RomanNumeral with style set to modern (4 = IV) with the value of the number equal to the RomanNumeral represented by the String
     * value.
     * </p>
     * 
     * @param value A String representing a Roman numeral
     * @exception NumberFormatException if the parameter is not a valid representation of a Roman numeral
     **************************************************************************/
    ...
    /***************************************************************************
     * <p>
     * Determines the integer value of a Roman digit, such as 'M', 'C', 'D', and so forth.
     * </p>
     * 
     * @param digit A character representing a Roman digit.
     * @return The integer value of the Roman digit parameter.
     * @exception NumberFormatException if a digit is not a valid Roman digit.
     **************************************************************************/
     ...
     * </p>
     * 
     * @param romanNum A string representing a Roman numeral
     * @return An int value of the string parameter
     * @exception NumberFormatException If the string parameter is not a valid Roman numeral
     **************************************************************************/
    ...
    /***************************************************************************
     * <p>
     * Allows the user to learn if the style of the Roman numeral is archaic (4 = IIII).
     * </p>
     * 
     * <p>
     ...
     * </p>
     * 
     * @return <code>true</code> if the style of the Roman numeral is archaic, else return <code>false</code>
     **************************************************************************/
    ...
    /***************************************************************************
     * <p>
     * Allows the user to learn if the style of the Roman numeral is modern (4 = IV).
     * </p>
     * 
     * <p>
     ...
     * </p>
     * 
     * @return <code>true</code> if the style of the Roman numeral is modern, else return <code>false</code>
     **************************************************************************/
