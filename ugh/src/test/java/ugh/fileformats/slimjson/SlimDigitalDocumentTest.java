...
public class SlimDigitalDocumentTest {
    ...
    @Test
    public void testSerializeDigitalDocument() throws PreferencesException, ReadException {
        ...
        assertEquals(convDoc.getPhysicalDocStruct().getAllChildren().size(),
                metsDoc.getDigitalDocument().getPhysicalDocStruct().getAllChildren().size());
