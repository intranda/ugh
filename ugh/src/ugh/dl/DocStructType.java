...
/*******************************************************************************
 * <p>
 * A <code>DocStructType</code> object defines a kind of class to which a
 * structure entitiy (represented by a DocStruct object) belongs. All DocStruct
 * objects belonging to a similar class have something in common (e.g. possible
 ...
 *      CHANGELOG
 * 
 *      13.02.2010 --- Funk --- Refcatored some overloaded methods, and set some
 *      methods deprecated.
 * 
 ...
 * 
 *      24.10.2008 --- Funk --- Commented out the field myPrefs and its getter
 *      and setter methods. We do not need that!
 * 
 ******************************************************************************/
...
public class DocStructType implements Serializable {
	...
	/***************************************************************************
	 * <p>
	 * List does not containg DocStructType objects but just the name (so just
	 * Strings).
	 * </p>
	 **************************************************************************/
	...
	/***************************************************************************
	 * <p>
	 * Sets information, wether this type is an anchor (virtual structure
	 * entity) or not.
	 * </p>
	 * 
	 * @param inBool
	...
	/***************************************************************************
	 * <p>
	 * Retrieves information, wether this type is an anchor or not. An anchor is
	 * a special type of document structure, which groups other structure
	 * entities togehter, but has no own content. E.h. a periodical as such can
	 * be an anchor. The perodical itself is a virtual structure entity without
	 * any own content, but groups all volumes together.
	 * </p>
	 * 
	...
	/***************************************************************************
	 * <p>
	 * Set a HashMap, which contain translations of the name of a DocStructType
	 * into several languages (e.g. for display in an user-interface). The key
	 * in the HashMap is the language code (iso-two-letter code) The value in
	 * the HashMap is the translation This methods replaces all other language
	 * information for this DocStructType object.
	 * </p>
	 * 
	 * @param in
	 *            HashMap containing language code and value
	 * @return always true
	 **************************************************************************/
	 ...
	 * </p>
	 * 
	 * @return HashMap with key/value pairs; key= language code; value=
	 ...
	 * @param value
	 *            translation of this StructType
	...
	public boolean addLanguage(String lang, String value) {
		...
		Iterator<Map.Entry<String, String>> it = this.allLanguages.entrySet()
				.iterator();
		while (it.hasNext()) {
			test = it.next();
			key = test.getKey();
	 ...
	 * @param lang
	 *            language code
	 * @return name of this DocStructType in the specified language; or null if
	 ...
	 * 
	 * @param lang
	 *            two-letter code of language, which should be removed
	...
	public boolean setAllMetadataTypes(List<MetadataType> in) {
		...
		for (MetadataType mdt : in) {
			MetadataTypeForDocStructType mdtfdst = new MetadataTypeForDocStructType(
					mdt);
	 ...
	 * </p>
	 * 
	 * @return List containing MetadataType objects; These MetadataType-objects
	 *         are just local objects
	 **************************************************************************/
	public List<MetadataType> getAllMetadataTypes() {

		List<MetadataType> out = new LinkedList<MetadataType>();

		Iterator<MetadataTypeForDocStructType> it = this.allMetadataTypes
				.iterator();
		while (it.hasNext()) {
	...
	/***************************************************************************
	 * <p>
	 * Retrieves all MetadataType objects for this DocStructType instance, that
	 * have the "DefaultDisplay" attribute in the configuration set to "true".
	 * </p>
	 * 
	 * @return List containing MetadataType objects; These MetadataType objects
	 *         are just local objects.
	...
	/**************************************************************************
	 * <p>
	 * Deprecated method, please use getAllDefaultDisplayMetadataTypes() in the
	 * future.
	 * </p>
	 * 
	 * @deprecated
	...
	/***************************************************************************
	 * <p>
	 * Gets the number of metadata objects, which are possible for a special
	 * MetadataType for this special document structure type. MetadataTypes are
	 * compared using the internal name.
	 * </p>
	 * 
	 * @param inType
	 *            MetadataType - can be a global type
	...
	/***************************************************************************
	 * <p>
	 * Gives very general information if a given MDType is allowed in a
	 * documentstructure of the type represented by this instance, or not.
	 * </p>
	 * 
	 * @param inMDType
	 *            MetadataType - can be a global type (with same internal name)
	...
	/***************************************************************************
	 * <p>
	 * Adds a MetadataType object to this DocStructType instance; this means,
	 * that all document structures of this type can have at least one metadata
	 * object of this type because for each DocStructType object we have
	 * separate MetadataType objects, the MetadataType instance given as the
	 * only parameter is duplicated; the copy of the given instance is added. If
	 * successful, the copy is returned - otherwise null is returned.
	 * </p>
	 * 
	 * @param type
	 *            MetadataType object which should be added
	 * @param inNumber
	 *            number, how often Metadata of type can be added to a DocStruct
	 *            object of this kind
	 * @return newly created copy of the MetadataType object; if not successful
	 *         null is returned
	 **************************************************************************/
	 ...
	 *            object of this kind
	 * @param isDefault
	 *            if set to true, this metadatatype will be displayed (even if
	 *            it's empty)
	 * @return newly created copy of the MetadataType object; if not successful
	 *         null is returned
	 **************************************************************************/
	public MetadataType addMetadataType(MetadataType type, String inNumber,
			boolean isDefault, boolean isInvisible) {
	...
	/***************************************************************************
	 * <p>
	 * Checks, if the MetadataType has already been added and is already
	 * available in the list of all MetadataTypes.
	 * </p>
	 * 
	 * @param type
	...
	public boolean removeMetadataType(MetadataType type) {
		...
		List<MetadataTypeForDocStructType> ll = new LinkedList(
	...
	/***************************************************************************
	 * <p>
	 * Retrieves the local MetadataType object (created when adding a global
	 * MetadataType object). This is necessary, if you just like to have the
	 * global MetadataType (from Preferences).
	 * </p>
	 * 
	 * @param inMDType
	 *            global MetadataType object (from Preferences)
	...
	/***************************************************************************
	 * <p>
	 * Add another DocStructType, which might be a children only the name (as
	 * String) is stored in the list; not the DocStructType object itself.
	 * </p>
	 * 
	 * @param inString
	 * @return
	...
	public boolean addDocStructTypeAsChild(String inString) {
		...
		if (this.allChildrenTypes.isEmpty()
				|| !this.allChildrenTypes.contains(inString)) {
	...
	/***************************************************************************
	 * <p>
	 * Removes the given type from the list of allowed children for the
	 * appropriate DocStruct.
	 * </p>
	 * 
	 * @param inString
	 *            name of the DocStructType
	...
	/***************************************************************************
	 *<p>
	 * Returns a List containing the names of all DocStructTypes which are
	 * allowed as children.
	 * </p>
	 * 
	 * @return
	...
	/***************************************************************************
	 * <p>
	 * This equals method only checks the attribute "name", because equality of
	 * the rules are not really necessary for the digital Document to be equal.
	 * </p>
	 * 
	...
	/***************************************************************************
	 * <p>
	 * Just a small class to store the MetadataType together with number (which
	 * depends on the DocStructType).
	 * </p>
	 **************************************************************************/
	...
	public class MetadataTypeForDocStructType implements Serializable {
		...
		/***********************************************************************
		 * Sets the DefaultDisplay variable for this DocStructType. Dosn't make
		 * any sense at all!
		 * 
		 * @param inDefaultdisplay
		 *            the defaultdisplay to set
		 **********************************************************************/
