...
public class DocStruct implements Serializable {
	 ...
	 * 
	 * @param theType
	 *            Type of the reference; e.g. "logical_physical" for references from logical structures to physical ones
	 * @return List containing <code>References</code> objects
	 **************************************************************************/
	 ...
	 * @throws MetadataTypeNotAllowedException
	 *             If the DocStructType of this DocStruct instance does not allow the MetadataType or if the maximum number of Metadata (of this type)
	 *             is already available.
	 * @throws DocStructHasNoTypeException
	 *             If no DocStruct Type is set for the DocStruct object; for this reason the metadata can't be added, because we cannot check, wether
	 *             if the metadata type is allowed or not.
	 * @see Metadata
	 **************************************************************************/
	 ...
	 * @param force
	 *            set to true, the Metadata is removed even if it is not allowed to. You can create not validateable documents.
	 ...
	 * @return true if successful
	 * @throws MetadataTypeNotAllowedException
	 *             if metadata could not be added, because the DocStructType configuration of this DocStruct instance does not allow metadata of this
	 *             type or this DocStruct instance has already the maximum number of metadata of this type. Information about possible maximum numbers
	 *             of metadata can be found in the <code>
	 * DocStructType</code> class.
	 * @throws IncompletePersonObjectException
	 *             if a person, which is added is not complete; e.g. the MetadataType is not set.
	 **************************************************************************/
	 ...
	 * @param force
	 *            if set to true, person is removed, even if invalid document is the result
	 ...
	 * @param personsTop
	 *            if true, person objects are at the beginning of the list, otherwise at the end
